...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xd:doc scope="stylesheet">
      <xd:desc>
         ...
         <xd:p>Set of functions for TAN-R-mor files. Used by Schematron
   ...
   <xsl:function name="tan:feature-test-seq" as="item()+">
      <!-- Recursive function written for strings generated by tan:feature-test-checker.
      Input: sequence of strings created by tan:feature-test-checker and an integer indicating the number of the last matched parenthesis
