...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xd:doc scope="stylesheet">
      <xd:desc>
         <xd:p><xd:b>Created on:</xd:b> June 6, 2015</xd:p>
         <xd:p><xd:b>Author:</xd:b> Joel</xd:p>
         <xd:p>Set of functions for TAN-R-tok files. Used by Schematron
            validation, but suitable for general use in other contexts </xd:p>
      </xd:desc>
   </xd:doc>
