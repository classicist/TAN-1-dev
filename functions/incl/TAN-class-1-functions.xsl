...
<xsl:stylesheet xmlns="tag:textalign.net,2015:ns" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:function name="tan:compare-copies" as="document-node()">
      ...
      <!-- Output: addition of @copy-loc to the first document's leaf divs, indicating at what character number a div's text is found in the copy. If the text is not found in the copy, the corresponding text from the copy is placed in @copy-text and @ref, with the faulty div's ref, is returned. -->
