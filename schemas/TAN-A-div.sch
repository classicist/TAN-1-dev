...
<!-- This version of the schema was started Feb 2016, to introduce phase-based
validation upon stylesheets that have few, slim global variables. The primary
schematron tests are in TAN-A-div-slow.sch, and need to be ported over here. -->
