...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:tan="tag:textalign.net,2015:ns"
   ...
   <!--<pattern id="self-analyzed" is-a="tan-file-resolved">
      <!-\- as of September 2016, no verbose version has been developed -\->
      <param name="self-version" value="tan:get-info($self-class-2-errors-marked, $self-prepped[position() gt 1])"/>
   </pattern>-->
